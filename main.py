...
if __name__ == '__main__':
    ...
    print(data_df["close"], (0, 10), (10, 20))

    # print(cl.manual_similarity_measure([98.19, 99.64], [98.32, 99.46], [98.43, 99.39], [98.41, 99.40], [98.57, 99.34],
    #                                   [98.71, 99.33], [98.66, 99.34], [98.72, 99.39], [98.80, 99.34], [98.70, 99.24]))
    # down below are different trending chunks of charts
    # print(cl.manual_similarity_measure([-.02, .07], [.13, -.18], [.11, -.07], [-.02, .01], [.16, -.06], [.14, -.01],
    #                                    [-.05, .01], [.06, .05], [.08, -.05], [-.10, -.10]))
    # # down below are kinda simillar chunks of charts
    # print(cl.manual_similarity_measure([-.02, .04], [.13, .13], [.11, .16], [-.02, .06], [.16, -.14], [.14, 18],
    #                                    [-.05, -.03], [.06, -.08], [.08, .04], [-.10, .01]))
